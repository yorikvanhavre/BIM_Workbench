...
class ViewProviderArchView(object):
    ...
    def set_properties(self, vobj):
        ...
        if not "DisplayLength" in pl:
            vobj.addProperty(
                ...
                "SectionPlane",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The display length of this section plane"
                ),
            )
            if d:
        ...
        if not "DisplayHeight" in pl:
            vobj.addProperty(
                ...
                "SectionPlane",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The display height of this section plane"
                ),
            )
            if d:
        ...
        if not "ArrowSize" in pl:
            vobj.addProperty(
                ...
                "SectionPlane",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The size of the arrows of this section plane"
                ),
            )
            vobj.ArrowSize = 50
    ...
    def setupContextMenu(self, vobj, menu):
        ...
        action1 = QtGui.QAction(
            QtGui.QIcon(":/icons/Draft_Edit.svg"), "Toggle Activate", menu
        )
        ...
        action2 = QtGui.QAction(
            QtGui.QIcon(":/icons/Draft_Edit.svg"), "Toggle Cutview", menu
        )
    ...
    def activate(self, vobj):
        ...
        Gui.ActiveDocument.ActiveView.setActiveObject(
            "part", vobj.Object
        )  # only Part objects are treated in autogroup with the placement correction
    ...
    def setup_sectionplane_marker(self, vobj):
        ...
        if (
            hasattr(self, "lcoords") and self.lcoords
        ):  # guarded when changed object type

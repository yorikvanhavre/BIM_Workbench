...
def default_sill(
    ...
    sill.Placement.Base = Vector(
        sill_wid * -0.5, host_thickness * -0.5 + inner_covering, sill_thickness * -1
    )
...
def add_preset_window_rectangular_subproperties(obj):
    ...
    obj.addProperty(
        "App::PropertyInteger", "NumberOfPanes", "Component - Filling - Options", _tip
    ).NumberOfPanes = 1

    _tip = "DESCRIBE."
    obj.addProperty(
        "App::PropertyLength", "FrameWidth", "Component - Filling - Options", _tip
    ).FrameWidth = 50.0

    _tip = "DESCRIBE."
    obj.addProperty(
        "App::PropertyLength", "FrameThickness", "Component - Filling - Options", _tip
    ).FrameThickness = 50.0

    _tip = "DESCRIBE."
    obj.addProperty(
        "App::PropertyLength", "GlassThickness", "Component - Filling - Options", _tip
    ).GlassThickness = 20.0

    _tip = "DESCRIBE."
    obj.addProperty(
        "App::PropertyLength", "IncreaseHeight", "Component - Filling - Options", _tip
    ).IncreaseHeight = 0.0

    _tip = "DESCRIBE."
    obj.addProperty(
        "App::PropertyLength", "IncreaseWidth", "Component - Filling - Options", _tip
    ).IncreaseWidth = 0.0


def window_rectangular(
    opening_th=300,
    opening_height=1400,
    opening_width=1200,
    frame_width=50,

...
class BIM_Column(ArchStructure._CommandStructure):
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(
                os.path.dirname(__file__), "icons", "BIM_Column.svg"
            ),
...
class BIM_Beam(ArchStructure._CommandStructure):
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(os.path.dirname(__file__), "icons", "BIM_Beam.svg"),
...
class BIM_Slab:
    ...
    def GetResources(self):
        return {
            "Pixmap": os.path.join(os.path.dirname(__file__), "icons", "BIM_Slab.svg"),
